...
public class ModConfig extends TXFConfig {
    ...
    @Entry(category = GENERAL, name = "Heal Amount", min = 0, max = Integer.MAX_VALUE, itemDisplay = "critterarmory:feed")
    public static int healAmount = 6;
    @Entry(category = GENERAL, name = "Health Increase Limit", min = 0, max = Integer.MAX_VALUE, itemDisplay = "critterarmory:premium_feed")
    public static int healthIncreaseLimit = 30;
    @Entry(category = GENERAL, name = "Health Increase Amount", min = 0, max = Integer.MAX_VALUE, itemDisplay = "critterarmory:premium_feed")
    ...
    public static boolean renderSheepArmors = true;
}

...
public class ModConfig extends TXFConfig {
    ...
    public static Comment rendering;
    ...
    @Entry(name = "Render Cat Armors", itemDisplay = "critterarmory:netherite_cat_armor")
    public static boolean renderCatArmors = true;
    ...
    @Entry(name = "Modern Wolf Collar", itemDisplay = "minecraft:bone")
